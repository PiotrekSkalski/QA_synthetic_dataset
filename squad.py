...
def squad_convert_example_to_features(example, max_seq_length, doc_stride, max_query_length, is_training, gpt):
    features = []
    ...
    for (i, token) in enumerate(example.doc_tokens):
        ...
        sub_tokens = tokenizer.tokenize(' ' + token if i != 0 and gpt else token)
    ...
    for span in spans:
        ...
        cls_index = 0 if gpt else span["input_ids"].index(tokenizer.cls_token_id)
